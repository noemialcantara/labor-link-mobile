              ...
              Padding(
                ...
                GestureDetector(
                  ...
                  onTap: () =>   Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (_) => UserProfileUpdateScreen(applicantData: applicant))).then((_) => _fetchUserData()),child: Text("Edit", style: GoogleFonts.poppins(fontSize: 20),))
              ],)),
              SizedBox(height: 40),
                        ...
                        return AlertDialog(
                          ...
                          content: Column(
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(hintText: "Enter the name of the skill"),
                            ),
                          ]),
                          actions: <Widget>[
                            TextButton(
                                                ...
                                                GestureDetector(
                                                  onTap: (){
                                                    AwesomeDialog(
                                                      ...
                                                      btnCancelOnPress: (){},
                                                      btnOkOnPress: () {
                                                        SkillsApi.deleteSkill(widget.email,snapshot.data?.docs[index].get("skill_name") ).then((value) => _fetchSkillsCount()
                                                        );
                                                      },
                                                      )..show();
                                                  },
