...
class _ChatUserCardState extends State<ChatUserCard> {
  ...
  Widget build(BuildContext context) {
    return Card(
      margin: EdgeInsets.symmetric(horizontal: MediaQuery.sizeOf(context).width * .04, vertical: 4),
      ...
      child: InkWell(
          ...
          child: StreamBuilder(
            stream: FirebaseChatApi.getLastMessage(widget.user),
              ...
              return ListTile(
                ...
                trailing: _message == null
                    ...
                    : _message!.read.isEmpty &&
                            _message!.fromId != FirebaseChatApi.user.uid
                        ?
