...
class _MessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    bool isMe = FirebaseChatApi.user.uid == widget.message.fromId;
    return InkWell(
        onLongPress: () {
  ...
  Widget _blueMessage() {
    ...
    if (widget.message.read.isEmpty) {
      FirebaseChatApi.updateMessageReadStatus(widget.message);
    }
        ...
        Flexible(
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(color: Color(0xfffbf0e8)),
          ...
          return ListView(
            ...
            children: [
              ...
              Container(
                height: 4,
                margin: EdgeInsets.symmetric(
                    vertical: MediaQuery.sizeOf(context).height * .015, horizontal: MediaQuery.sizeOf(context).width * .4),
                decoration: BoxDecoration(
              ...
              if (isMe)
                _OptionItem(
                    ...
                    name: 'Delete Message',
                    onTap: () async {
                      await FirebaseChatApi.deleteMessage(widget.message).then((value) {
                        //for hiding bottom sheet
                        Navigator.pop(context);
                      });
                    }),
              ...
              actions: [
                ...
                MaterialButton(
                    onPressed: () {
                      //hide alert dialog
                      Navigator.pop(context);
                      FirebaseChatApi.updateMessage(widget.message, updatedMsg);
                    },
                    child: const Text(
                      'Update',
                      style: TextStyle(color: Colors.blue, fontSize: 16),
