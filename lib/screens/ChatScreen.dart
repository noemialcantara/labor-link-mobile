          ...
          child: Scaffold(
            ...
            body: Column(
              children: [
                Expanded(
                  child: StreamBuilder(
                    stream: FirebaseChatApi.getAllMessages(widget.user),
  ...
  Widget _chatInput() {
    return Padding(
      padding: EdgeInsets.symmetric(
          vertical: MediaQuery.sizeOf(context).height * .01, horizontal: MediaQuery.sizeOf(context).width * .025),
      child: Row(
        children: [
          //input field & buttons
          Expanded(
                ...
                children: [
                  ...
                  IconButton(
                      ...
                      icon: const Icon(Icons.emoji_emotions,
                          color: Color(0xff7E7E7E), size: 25)),
                  ...
                  IconButton(
                      onPressed: () async {
                        ...
                        for (var i in images) {
                          ...
                          await FirebaseChatApi.sendChatImage(widget.user, File(i.path));
                          setState(() => _isUploading = false);
                        }
                      },
                      icon: const Icon(Icons.image,
                          color: Color(0xff7E7E7E), size: 26)),
                  ...
                  IconButton(
                      onPressed: () async {
                        ...
                        if (image != null) {
                          ...
                          await FirebaseChatApi.sendChatImage(
            ...
            onPressed: () {
              if (_textController.text.isNotEmpty) {
                if (_messageList.isEmpty) {
                  ...
                  FirebaseChatApi.sendFirstMessage(
