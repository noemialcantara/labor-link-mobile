...
class JobApplicationSuccessScreen extends StatefulWidget {
  ...
  JobApplicationSuccessScreen({Key? key, required this.jobDetails}) : super(key: key);

  @override
  State<JobApplicationSuccessScreen> createState() => _JobApplicationSuccessScreenState();
}

class _JobApplicationSuccessScreenState extends State<JobApplicationSuccessScreen> {
      ...
      body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height:10),
              Center(child: Image.network("https://firebasestorage.googleapis.com/v0/b/labor-link-f9424.appspot.com/o/app_image_assets%2FDone-rafiki%201%20(1).png?alt=media&token=f6f58e4a-e7d5-4013-8db3-b6552daca3e3",height:300, width:300)),
              Center(child: Text("Job Application Successful!", style: GoogleFonts.poppins(fontSize: 23, fontWeight: FontWeight.bold),)),
              Padding(
                padding: EdgeInsets.only(left:20,right:20,top:15),
                child: 
                Center(child: Text("You've successfully applied to ${widget.jobDetails.companyName} as ${widget.jobDetails.jobName}. You can see the job status from Application Tracking", textAlign: TextAlign.center,  style: GoogleFonts.poppins(fontSize: 18,color: Color(0xff95969D)),))
              ),
              SizedBox(height:30),
              Padding(
