...
class EmployerHomeDashboardScreen extends StatefulWidget {
  ...
  @override
  _EmployerHomeDashboardScreenState createState() =>
      _EmployerHomeDashboardScreenState();
}

class _EmployerHomeDashboardScreenState
    extends State<EmployerHomeDashboardScreen> {
  ...
  fetchKPIs() {
    if (mounted) {
      UsersApi.getCompanyNameByEmail(FirebaseAuth.instance.currentUser!.email!)
          .then((value) {
        ...
        JobApplicationApi.getQueryJobListByEmployerWithStatus(
                companyName, "Hired")
            .then((value) {
          int dataLength = value.docs.length;
          setState(() {
                        ...
                        child: Padding(
                            ...
                            child: Column(children: [
                              Row(
                                children: [
                                  Image.asset(
                                    "assets/icons/multiple_users_icon.png",
                                    height: 20,
                                  ),
                                  SizedBox(width: 10),
                                  SizedBox(
                              ...
                              SizedBox(
                                  ...
                                  child: Text(applicantsCount.toString(),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                        ...
                        child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              SizedBox(
                                  width: MediaQuery.sizeOf(context).width -
                                      (MediaQuery.sizeOf(context).width * 0.7),
                                  child: Text(jobPostingCount.toString(),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.poppins(
                        ...
                        child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              SizedBox(
                                  width: MediaQuery.sizeOf(context).width -
                                      (MediaQuery.sizeOf(context).width * 0.7),
                                  child: Text(hiredCount.toString(),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.poppins(
                        ...
                        child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              SizedBox(
                                  width: MediaQuery.sizeOf(context).width -
                                      (MediaQuery.sizeOf(context).width * 0.7),
                                  child: Text(rejectedCount.toString(),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.poppins(
