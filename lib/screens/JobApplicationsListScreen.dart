...
class JobApplicationsListScreen extends StatefulWidget {
  ...
  JobApplicationsListScreen({Key? key, required this.userName})
      : super(key: key);
              ...
              if (streamDataLength > 0)
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, index) => GestureDetector(
                      onTap: () {
                        String companyName =
                            snapshot.data?.docs[index].get("company_name");

                        UsersApi.getEmployerDataByName(companyName)
                            .then((value) {
                          setState(() {
                            employerEmailAddress =
                                value.docs.first.get("email_address");
                          });
                        });
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (_) => JobApplicationTrackingScreen(
                                      companyLogo: snapshot.data?.docs[index]
                                          .get("company_logo_url"),
                                      jobCityLocation: snapshot
                                          .data?.docs[index]
                                      ...
                                      jobName: snapshot.data?.docs[index]
                                          .get("job_name"),
                                      minimumSalary: snapshot.data?.docs[index]
                                          .get("min_salary"),
                                      status: snapshot.data?.docs[index]
                                          .get("status"),
                                      companyEmail: employerEmailAddress,
                                            ...
                                            child: Text(
                                                ...
                                                style: GoogleFonts.poppins(
                                                    ...
                                                    color: snapshot.data
                                                            ...
                                                            "Rejected"
                                                        ? Color(0xffDC312D)
                                                        : snapshot.data?.docs[index].get("status") == "Hired"
                                                            ? Color(0xff0E9D57)
                                                            : Color(0xff5386E4)))))),
                                Container(
        ...
        body: SingleChildScrollView(
            child: Column(
              ...
              Padding(
                padding: EdgeInsets.only(left: 30, right: 30),
                child: Text(
                  'You have $applicationCount Application(s)',
