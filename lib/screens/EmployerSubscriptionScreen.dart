                      ...
                      onTap: () {
                        setState(() {
                          subscriptionPlan = SubscriptionPlan(
                              ...
                              snapshot.data?.docs[index].get("plan_name"),
                          ...
                          child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "Payment is by ${snapshot.data?.docs[index].get("duration")} - PHP ${snapshot.data?.docs[index].get("price")}",
                                      style: GoogleFonts.poppins(
                                          fontSize: 15,
                                          color: Color(0xff356899)))
                                ],
    ...
    return Scaffold(
        body: SingleChildScrollView(
          ...
          Padding(
              ...
              child: Center(
                  child: Text(
                "Get unlimited job postings at your fingertips!",
          ...
          Padding(
              ...
              child: Center(
                  child: Text(
                "You only have 10 free job postings in this free plan. Choose a plan from below to post unlimited jobs.",
                textAlign: TextAlign.center,
                style:
                    GoogleFonts.poppins(fontSize: 16, color: Color(0xff95969D)),
              ))),
          SizedBox(height: 40),
          ...
          Padding(
              ...
              child: CustomButton(
                  text:
                      "Subscribe to ${subscriptionPlan?.duration ?? "monthly"} offer",
                  onTap: () {
                    if (subscriptionPlan == null) {
                      AwesomeDialog(
                          ...
                          title: 'Alert!',
                          desc:
                              'Please select a subscription plan first from the list above.',
                          btnOkOnPress: () {});
                    } else {
          ...
          Padding(
              ...
              child: Text(
                ...
                style:
                    GoogleFonts.poppins(color: Color(0xffAFB0B6), fontSize: 12),
              ))
        ])));
  }
}
